...
class TestGreeniProductSeeding(TestCase):
    ...
    def test_delta_seeding(self):
        ...
        self.assertEqual(len(documents), 1 + 1 + 2, "Expected 1 addition, 1 update and 2 deletes")
        self.assertEqual(
            self.set.documents.count(), 100 + 1 + 1,
            "Expected 100 initial Documents and one additional and one extra deleted Document"
        )
