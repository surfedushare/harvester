...
ANATOMY_TOOL_EXTRACTION_OBJECTIVE = {
    ...
    "set": lambda soup, el: f"oaipmh:{AnatomyToolExtraction.get_oaipmh_external_id(soup, el)}",
    ...
    "research_product.research_object_type": lambda soup, el: None,
    "research_product.research_themes": lambda soup, el: [],
    "research_product.parties": lambda soup, el: [],
}
