...
from files.models import VideoThumbnailResource


class TestYoutubeThumbnailResource(TestCase):

    def test_get_preview_filename(self):
        jpeg_filename = VideoThumbnailResource.get_preview_filename(
        ...
        webp_filename = VideoThumbnailResource.get_preview_filename(
