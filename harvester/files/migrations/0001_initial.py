    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('document', 'Document'), ('app', 'App'), ('image', 'Image'), ('website', 'Website'), ('spreadsheet', 'Spreadsheet'), ('?', '?'), ('video', 'Video'), ('unknown', 'Unknown'), ('audio', 'Audio'), ('presentation', 'Presentation')], default='unknown', max_length=50)),
