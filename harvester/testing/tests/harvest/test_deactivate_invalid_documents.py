...
class TestDeactivateInvalidDocuments(TestCase):
    ...
    def test_deactivate_invalid_documents(self):
        ...
        self.assertEqual(valid_document.task_results, {
        ...
        self.assertTrue(invalid_document.task_results["deactivate_invalid_documents"]["success"])
        validation_errors = invalid_document.task_results["deactivate_invalid_documents"]["validation"]
        ...
        self.assertEqual(default_document.task_results, {
            "deactivate_invalid_documents": {"success": True, "validation": None}
        })
