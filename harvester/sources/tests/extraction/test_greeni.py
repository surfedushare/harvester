...
class TestGetHarvestSeedsGreeni(TestCase):
    ...
    def test_authors_property(self):
        ...
        self.assertEqual(seeds[0]['authors'], [
            {'name': 'W. Timmermans', 'email': None, 'external_id': "greeni:PUBVHL:c2608093b5888169d775d89cef451807826ae380", 'dai': None, 'orcid': None, 'isni': None},
            {'name': 'J. Jonkhof', 'email': None, 'external_id': "greeni:PUBVHL:a93b9d1a8e05abc28253b2b667f562ab91e65448", 'dai': None, 'orcid': None, 'isni': None},
        ])
