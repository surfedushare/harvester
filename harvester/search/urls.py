...
public_api_patterns = [
    ...
    path(
        r'search/documents/explain/', views.ExplainDocumentSearchAPIView.as_view(),
        name="search-documents-explain"
    ),
    ...
    path(r'suggestions/author/', views.AuthorSuggestionsAPIView.as_view(), name="suggestions-author"),
]
