...
class FileDocumentAdmin(DocumentAdmin):
    list_display = DocumentAdmin.list_display + \
        ("product_link", "is_not_found", "is_analysis_allowed", "is_invalid",)
    list_filter = DocumentAdmin.list_filter + ("type", "mime_type", "is_not_found", "is_analysis_allowed", "is_invalid",)
