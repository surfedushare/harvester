    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('harvest_set', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='testing.set')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='historic_sets',
            field=models.ManyToManyField(blank=True, to='testing.Set'),
        ),
        migrations.AddField(
            model_name='datasetversion',
            name='index',
