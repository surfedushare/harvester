...
import products.models.datatypes.product
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dataset', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='versions', to='products.dataset')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dataset_version', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='sets', to='products.datasetversion')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tasks', models.JSONField(blank=True, default=products.models.datatypes.product.default_document_tasks)),
                ('collection', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='document_set', to='products.set')),
                ('dataset_version', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='documents', to='products.datasetversion')),
                ('overwrite', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='products.overwrite')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('document', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='products.productdocument')),
        ...
        migrations.AddField(
            ...
            name='collection',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='products.set'),
        ),
        migrations.CreateModel(
            name='HarvestState',
            fields=[
                ...
                ('dataset', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='products.dataset')),
                ('entity', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='+', to='sources.harvestentity')),
                ('harvest_set', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='products.set')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='historic_sets',
            field=models.ManyToManyField(blank=True, to='products.Set'),
        ),
        migrations.AddField(
            model_name='datasetversion',
            name='index',
        ...
        migrations.AddField(
            model_name='dataset',
            name='entities',
            field=models.ManyToManyField(related_name='_products_dataset_entities_+', through='products.HarvestState', to='sources.HarvestEntity'),
        ),
        migrations.AddField(
            model_name='batch',
            name='documents',
            field=models.ManyToManyField(through='products.ProcessResult', to='products.ProductDocument'),
        ),
    ]
