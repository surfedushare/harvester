# Generated by Django 4.2.16 on 2024-11-12 17:12
...
import organizations.models.datatypes.organization
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dataset', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='versions', to='organizations.dataset')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tasks', models.JSONField(blank=True, default=organizations.models.datatypes.organization.default_document_tasks)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            name='SharekitOrganizationResource',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dataset_version', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='sets', to='organizations.datasetversion')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('document', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='organizations.organizationdocument')),
        ...
        migrations.AddField(
            ...
            name='collection',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='document_set', to='organizations.set'),
        ),
        migrations.AddField(
            model_name='organizationdocument',
            name='dataset_version',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='documents', to='organizations.datasetversion'),
        ),
        migrations.CreateModel(
            name='HarvestState',
            fields=[
                ...
                ('dataset', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='organizations.dataset')),
                ('entity', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='+', to='sources.harvestentity')),
                ('harvest_set', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='organizations.set')),
            ],
            options={
        ...
        migrations.CreateModel(
            name='HanzeOrganizationResource',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('uri', models.CharField(db_index=True, default=None, max_length=255)),
                ('status', models.PositiveIntegerField(default=0)),
        ...
        migrations.AddField(
            ...
            name='historic_sets',
            field=models.ManyToManyField(blank=True, to='organizations.set'),
        ),
        migrations.AddField(
            model_name='datasetversion',
            name='index',
        ...
        migrations.AddField(
            model_name='dataset',
            name='entities',
            field=models.ManyToManyField(related_name='+', through='organizations.HarvestState', to='sources.harvestentity'),
        ),
        migrations.AddField(
            model_name='batch',
            name='documents',
            field=models.ManyToManyField(through='organizations.ProcessResult', to='organizations.organizationdocument'),
        ),
    ]
