    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('audio', 'Audio'), ('unknown', 'Unknown'), ('website', 'Website'), ('document', 'Document'), ('video', 'Video'), ('presentation', 'Presentation'), ('image', 'Image'), ('spreadsheet', 'Spreadsheet'), ('app', 'App'), ('?', '?')], default='unknown', max_length=50)),
