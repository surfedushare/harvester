...
ENDPOINT = HanzeResearchObjectResource.URI_TEMPLATE.replace("https://", "")


class HanzeResearchObjectResourceFactory(factory.django.DjangoModelFactory):

    class Meta:
        model = HanzeResearchObjectResource
    ...
    def body(self):
        ...
        response_file = f"fixture.hanze.{response_type}.{self.number}.json"
