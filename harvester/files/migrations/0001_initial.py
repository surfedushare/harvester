    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('spreadsheet', 'Spreadsheet'), ('document', 'Document'), ('app', 'App'), ('image', 'Image'), ('unknown', 'Unknown'), ('video', 'Video'), ('?', '?'), ('presentation', 'Presentation'), ('website', 'Website'), ('audio', 'Audio')], default='unknown', max_length=50)),
